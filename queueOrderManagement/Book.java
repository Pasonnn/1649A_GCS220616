public class Book {
    ...
    private String ISBN; // ISBN number, which uniquely identifies the book
    private int stock; // Number of books available in stock
    ...
    // Method to decrement the stock by 1, if there are books available

    // Decreases the stock by 1 if stock is greater than zero
    public void decrementStock() {
        if (stock > 0) {
            stock--; // Decrementing stock by 1
        }
    }
